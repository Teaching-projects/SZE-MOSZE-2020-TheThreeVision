...
public:
/**
	 * \brief This method can search a std::string and get the useful informations.
    ...
    /**
	 * \brief This method opens a .json file and returns the useful informations in a std::map.
	 * \return return with a std::map
	 * \throw throw a "runtime_error" if something wrong
	 */
    static std::map<std::string, std::string> ParseJsonFilename(std::string FilenameToParse);
    /**
	 * \brief This method reads a .json file and returns the useful informations in a std::map.
	 * \return return with a std::map
	 * \throw throw a "runtime_error" if something wrong
	 */
    static std::map<std::string, std::string> ParseJson(std::istream& JSONToParse);
    /**
	 * \brief This method reads a .json file as std::string and returns the useful informations in a std::map.
	 * \return return with a std::map
	 * \throw throw a "runtime_error" if something wrong
	 */
